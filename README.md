...
![Каталог товаров](./practic28/screenshots/catalog.png)
*Просмотр товаров с фильтрацией и поиском*

### Корзина покупок
![Корзина](./practic28/screenshots/cart.png)
*Управление товарами в корзине*

### Оформление заказа (Stripe Checkout)
![Оплата](./practic28/screenshots/stripe-payment.png)
*Безопасная оплата через Stripe*

### История заказов
![История](./practic28/screenshots/orders.png)
*Просмотр статусов заказов*

### Панель администратора
![Админка](./practic28/screenshots/admin-panel.png)
*Управление товарами и пользователями*

### Редактирование товара
![Редактирование](./practic28/screenshots/edit-product.png)
